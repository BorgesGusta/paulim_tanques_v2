...
export function ClientLogos() {
  ...
  return (
    <section aria-label="Empresas que confiam na Paulim Tanques" className="overflow-hidden bg-brand-deep py-6">
      <p className="section-shell mb-4 text-center text-xs font-bold uppercase tracking-[0.16em] text-primary-foreground/50">
        ...
        {track.map((client, index) => (
          ...
          >
            {client.logoSrc ? (
              ...
              <div className="flex items-center gap-2 text-primary-foreground/35">
